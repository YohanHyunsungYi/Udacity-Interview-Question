...
Not only that, I will continue to participate in extracurricular activities such as leading a team of software developers to build programs for non-profit organizations and other people who are in need. Also I will keep building a codebase and framework for the company I am in. I will also keep creating for my own benefits. So I will continue with Udacity programs and obtain more professional certificates. I plan to take 'React Nanodegrees' and 'Android Nano Degree' at Udacity, so that I can create and build android applications as well.
